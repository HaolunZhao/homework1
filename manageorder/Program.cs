...
namespace manageorder
{
    ...
    class OrderService//订单服务
    {
        ...
        public void export()//export()可以将所有的订单序列化为XML文件
        {
        ...
        public void import()//import方法可以从XML文件中载入订单
        {
            try
            {
                XmlSerializer a = new XmlSerializer(typeof(List<Order>));
 ...
 public class Order//单个订单
    {
        ...
        {
            OrderDetails a = new OrderDetails(name, number, price);//新增加的订单商品名，商品数量，金额
    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            while (judge_)
            {
                ...
                Console.WriteLine("输入6序列化订单");
                Console.WriteLine("输入7反序列化订单"); 
                Console.WriteLine ("输入8退出");
